...
parser.add_argument('-c',
                    ...
                    default='#fff',
                    metavar='C',
                    help='set color of underline (progress bar)')
parser.add_argument('-p',
                    '--property',
                    choices=['pause', 'time-pos', 'playlist-pos'],
                    help='update mpv property and exit')
...
if args.property:
    ...
    if args.property == 'pause':
        ...
        update_property(
            args.property,
            lambda msg: json.loads(msg)['data'] + int(args.args[0]))
...
while True:
    ...
    for m in parse_msg(msg):
        ...
        elif (m.get('id') == 1 or m.get('request_id') == 1) and isinstance(
                data, dict):
